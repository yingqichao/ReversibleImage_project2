...
class Prep_pureUnet(nn.Module):
    def __init__(self,input_channel=3, config=GlobalConfig()):
        ...
        # 64
        self.downsample_6 = SingleConv(64, out_channels=128, kernel_size=5, stride=1, dilation=1, padding=2)
        # self.Down2_conv_7 = SingleConv(128, out_channels=128, kernel_size=7, stride=1, dilation=1, padding=3)
        # 32
        self.downsample_5 = SingleConv(128, out_channels=256, kernel_size=5, stride=1, dilation=1, padding=2)
        # 16
        self.downsample_4 = SingleConv(256, out_channels=512, kernel_size=5, stride=1, dilation=1, padding=2)
        # 8
        ...
        self.upsample1_3 = nn.Sequential(
            PureUpsampling(scale=2),
            nn.Conv2d(128, 3, kernel_size=5, stride=1, dilation=1, padding=2),
            nn.Tanh()
        )
