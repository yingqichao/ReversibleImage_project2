...
class ReversibleImageNetwork_hanson:
    ...
    def train_on_batch(self, Cover, Another):
        ...
        self.alpha -= batch_size/(2*118287)
        ...
        with torch.enable_grad():
            ...
            loss_D_B = (loss_D_B_A+loss_D_B_B)/2
            loss_D_B.backward()
            ...
            loss_256A = 0.5*loss_R256_global+loss_R256_globalPSNR*100+loss_R256_local*100
            loss_256B = 0.5*loss_R256_globalB+loss_R256_globalPSNRB*100+loss_R256_localB*100
            ...
            g_loss_adv_recovery = (g_loss_adv_recoveryA+g_loss_adv_recoveryB)/2
