...
class ReversibleImageNetwork_hanson:
    ...
    def save_state_dict_all(self, path):
        ...
        torch.save(self.discriminator_patch.state_dict(), path + '_discriminator_patch.pkl')
        print("Successfully Saved: " + path + '_discriminator_patch.pkl')
    ...
    def save_model(self,path):
        ...
        torch.save(self.discriminator_patch, path + '_discriminator_patch.pth')
        print("Successfully Saved: " + path + '_discriminator_patch.pth')
    ...
    def load_model(self,path):
        ...
        self.discriminator_patch = torch.load(path + '_discriminator_patch.pth')
        print(self.discriminator_patch)
        print("Successfully Loaded: " + path + '_discriminator_patch.pth')
